...
**Status:** Planned (approved 2026-08-12)
...
This plan document + implementation in the priority order above, each track gated and documented. On approval: mirror this content into `doc/2026-08-12-next-implementation-plan.md` and add a `doc/README.md` index row, then implement Priority 0 first.
